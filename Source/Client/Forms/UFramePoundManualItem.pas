...
uses
  ...
  UMgrPoundTunnels, UBusinessConst, cxGraphics, cxControls, cxLookAndFeels, USysLoger,
    ...
    begin
      ...
      begin
        ...
        begin
          ...
          begin
            nStr:= Format('%s 提货量：%s 退货量：%s 退货量不能大于提货量', [FBillItems[0].FID, FBillItems[0].FValue,
